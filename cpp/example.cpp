...
int main() {
    ...
    TestCase tests[] = {
        {  0,  33, 133, 252, 211,   0, 0.50f,  42, 148,  49, "Blue + Yellow (the green problem)"},
        {255,   0,   0, 255, 255, 255, 0.50f, 255,  72, 116, "Red + White"},
        {  0,   0, 255, 255, 255,   0, 0.25f,  10, 100, 151, "Blue + Yellow t=0.25"},
        {255,   0,   0,   0,   0, 255, 0.50f, 102,   0,  88, "Red + Blue"},
        {128, 128, 128, 128, 128, 128, 0.50f, 128, 128, 128, "Gray + Gray"},
    };
